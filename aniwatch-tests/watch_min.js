!(function (b) {
  (function () {
    ...
    function n(e, t) {
      var n,
        i,
        o = e.length;
      if (o && t) for (n = t.toLowerCase(), i = 0; i < o; ++i) if (n === e[i].toLowerCase()) return true;
      return false;
    }
    function e(e) {
    ...
    for (i in d.props)
      if (u.call(d.props, i)) {
        for (r = d.props[i], c = (r = S(r) ? r : [r]).length, s = 0; s < c; ++s)
          0 <= (l = (a = r[s]).indexOf("[VER]")) && (a = a.substring(0, l) + "([\\w._\\+]+)" + a.substring(l + 5)), (r[s] = new RegExp(a, "i"));
        d.props[i] = r;
      }
    return (
      e(d.oss),
      ...
      (o.prototype = {
        ...
        is: function (e) {
          return (
            n(this.userAgents(), e) ||
            (null != e && null != this.os() && e.toLowerCase() === this.os().toLowerCase()) ||
            (null != e && null != this.phone() && e.toLowerCase() === this.phone().toLowerCase()) ||
            (null != e && null != this.tablet() && e.toLowerCase() === this.tablet().toLowerCase()) ||
  ...
  !(function (e, t) {
          ...
          var i,
            ...
            T =
              "[object SafariRemoteNotification]" ===
                ((null == (n = null == (i = null == n ? void 0 : n.window) ? void 0 : i.safari) ? void 0 : n.pushNotification) || false).toString() ||
              (/safari/i.test(t.b) && !l);
        },
        function (e, t, n) {
          "use strict";
                  ...
                  return function (e) {
                    ...
                    for (; c; )
                      try {
                        if (
                          ((r = 1),
                          a && (s = 2 & t[0] ? a.return : t[0] ? a.throw || ((s = a.return) && s.call(a), 0) : a.next) && !(s = s.call(a, t[1])).done)
                        )
                          return s;
                        switch (((a = 0), (t = s ? [2 & t[0], s.value] : t)[0])) {
                          ...
                          case 1:
                            ...
                            break;
                          case 4:
                            return c.label++, { value: t[1], done: false };
                          case 5:
                            c.label++, (a = t[1]), (t = [0]);
                            continue;
                          case 7:
              ...
              (r.prototype._detectLoop = function () {
                return i(this, void 0, void 0, function () {
                  ...
                  return s(this, function (e) {
                    switch (e.label) {
                      case 0:
                        (t = false), (n = ""), (i = 0), (o = this._checkers), (e.label = 1);
                      case 1:
              ...
              }),
              {
                ...
                isOpen: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return (l = false), Object(o.c)({ dep: c }), Object(o.a)(), [2, l];
                    });
                  });
                },
                isEnable: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return [2, Object(r.b)({ includes: [true], excludes: [i.c, i.d] })];
                    });
                  });
                }
              });
            ...
            T =
              ...
              }),
              {
                ...
                isOpen: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return (l = false), Object(o.b)(c), Object(o.a)(), [2, l];
                    });
                  });
                },
                isEnable: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return [2, Object(r.b)({ includes: [true], excludes: [i.d, i.b, i.c] })];
                    });
                  });
                }
              });
            ...
            u =
              ...
              }),
              {
                ...
                isEnable: function () {
                  return s(this, void 0, void 0, function () {
                    return c(this, function (e) {
                      return [2, Object(a.b)({ includes: [true], excludes: [i.e, i.c, (r.b || r.c) && i.a] })];
                    });
                  });
                }
              });
            ...
            T =
              ...
              }),
              {
                ...
                isOpen: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return (l = false), Object(i.b)(c), Object(i.a)(), [2, l];
                    });
                  });
                },
                isEnable: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return [2, Object(r.b)({ includes: [true], excludes: [o.g] })];
                    });
                  });
                }
              });
                ...
                return i(this, void 0, void 0, function () {
                  return o(this, function (e) {
                    return "undefined" != typeof eruda
                      ? [2, true === (null == (t = null === eruda || void 0 === eruda ? void 0 : eruda._devTools) ? void 0 : t._isShow)]
                      : [2, false];
                  });
                });
              },
    ...
    function i(e) {
      var t;
      return (o[e] || ((t = o[e] = { i: e, l: false, exports: {} }), n[e].call(t.exports, t, t.exports, i), (t.l = true), t)).exports;
    }
    var n, o;
  });
...
function getCommentWidget(e, t = false) {
  var n = `/ajax/comment/widget/${movieId}?episodeId=${epId}&sort=` + cmSort,
    i =
      (currentUrl.search &&
        ...
        i.get("c_type") &&
        ((e = i.get("c_type")), (n = n + "&cId=" + i.get("c_id")), (t = true)),
      (n = n + "&type=" + e),
    ...
    $.get(n, function (e) {
      ...
      $("#content-comments").html(e.html),
        e.gotoId &&
          ...
          0 < (t = $("#cm-" + e.gotoId)).length ? t.addClass("comment-focus") : getReplies(e.cParentId, e.gotoId));
    }));
}
$(document).on("click", "#cm-view-more", function () {
  if (!commentLoading) {
    ...
    $.get(e, function (e) {
      (commentLoading = false), e && e.status && (0 < e.nextPage ? n.data("page", e.nextPage) : n.remove(), $(".cw_list").append(e.html));
    });
  }
}),
  $(document).on("click", ".cm-report", function () {
    ...
    checkLogin() &&
      ...
      $.post("/ajax/comment/report", { id: e, type: t }, function (e) {
        (commentLoading = false), e.status ? toastr.success(e.msg, "", { timeOut: 6e3 }) : toastr.error(e.msg, "", { timeOut: 6e3 });
      }));
  }),
  $(document).on("click", ".cm-sort", function () {
    (cmSort = $(this).data("value")), getCommentWidget($(".cm-by.active").data("value"), true);
  }),
  $(document).on("click", ".cm-by", function () {
    getCommentWidget($(this).data("value"), true);
  }),
  ...
  $(document).on("click", ".cm-btn-vote", function () {
    ...
    checkLogin() &&
      ...
      0 < (o = $(".cm-btn-vote[data-id=" + n + "].active")).length &&
        ...
        (o.removeClass("active"), 0 < (i = parseInt(o.find(".value").text()))) &&
      ...
      $.post("/ajax/comment/vote", { id: n, type: t }, function (e) {
        (commentLoading = false), e.status || toastr.error(e.msg, "", { timeOut: 6e3 });
      }));
  }),
                ...
                e && e.status
                  ? (0 < parseInt(e.parentId)
                      ? (0 < (t = $("#block-reply-" + e.parentId)).length
                          ? t.html(e.html)
                          : $("#cm-" + e.parentId).append(`<div class="replies" id="block-reply-${e.parentId}">${e.html}</div>`),
  ...
  "watch" === page &&
    ...
    setTimeout(function () {
      $.post("/ajax/movie/count-view/" + movieId, function (e) {
        Cookies.set("watched_" + movieId, true, { path: "/", expires: 0.08333333333333333 });
      });
    }, 6e4);
}
...
$(document).ready(function () {
  ...
  0 < $(".schedule-alert").length &&
    ((e = new Date($("#schedule-date").data("value").split(" ").join("T") + "Z")), $("#schedule-date").text(e.toLocaleString("en-US"))),
    countViewMovie(),
    $.get("/ajax/v2/episode/list/" + movieId, function (e) {
      ...
      e &&
        ...
        (0 < (e = document.querySelectorAll('.ep-item[data-id="' + urlGetParamByName().ep + '"]')).length
          ...
          : ((e = localStorage.getItem("watching." + movieId)),
            (t = document.querySelectorAll('.ep-item[data-id="' + e + '"]')),
            e && 0 < t.length ? t[0] : $(".ss-list").first().find(".ep-item").first())
        ).click(),
        0 < $(".ep-page-item").length
          ? $(".ep-page-item[data-page=" + $(".ep-item.active").parent().data("page") + "]").click()
          : $("#episodes-page-" + $(".ep-item.active").parent().data("page")).show());
    }),
      ...
      $("#embed-loading").hide(),
        e &&
          ...
          0 <= [1, 4].indexOf(parseInt(e.server)) &&
            ((t += "&autoPlay=" + userSettings.auto_play + "&oa=" + (userSettings.play_original_audio || 0) + "&asi=" + userSettings.auto_skip_intro),
            continueWatch) &&
...
eventer(messageEvent, function (e) {
  var t,
    ...
    i = e.data || e.message;
  try {
    "megacloud" === (i = JSON.parse(i)).channel &&
      ("complete" === i.event && 1 === parseInt(userSettings.auto_next) && nextEpisode(),
      "time" === i.event && ((playerCurrentTime = i.time), (playerCurrentPercent = i.percent), (playerDuration = i.duration)),
      "error" === i.event) &&
  ...
  $(document).on("click", ".player-time", function () {
    ...
    $(window).scrollTo(0, { duration: 200 }),
      document.getElementById("iframe-embed").contentWindow.postMessage(JSON.stringify({ event: "seek", time: e }), "*");
  }),
  ...
  $(document).on("click", ".ep-item", function (e) {
    ...
    (t.episode = $(this).data("number")),
      ...
      firstLoad && currentUrl.search
        ? ((firstLoad = false), history.pushState({}, "", window.location.origin + window.location.pathname + currentUrl.search))
      ...
      $.get("/ajax/v2/episode/servers?episodeId=" + epId, function (e) {
        ...
        e &&
          ...
          (e = (t = urlGetParamByName().source) ? t : e) && 0 < $(".servers-" + e).length
            ? ((t = localStorage.getItem(keyLsCurrentServer)),
              (n = $(".servers-" + e + " .server-item[data-server-id=" + t + "]")),
              (t && 0 < n.length ? n : $(".servers-" + e + " .server-item").first()).click())
