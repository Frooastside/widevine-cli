...
var j = {
    ...
    var O6, O7;
}), jwplayer('megacloud-player')), R = [], i = [], q = [], X = false, l = [], z = Boolean(parseInt(settings.autoPlay)), U = Boolean(parseInt(settings.playOriginalAudio)), d = Boolean(parseInt(settings.vast)), g = $('#megacloud-player').data('id'), E = $('#megacloud-player').data('realid'), v = parseInt(settings.time), e = { 'channel': 'megacloud' }, b, F;
;
const sourcesUrl = '/embed-2/ajax/e-1/getSources?id=' + g, f = O5 => {
    ;
    ;
    var O6 = '2zHcpXS0TqqeS8wf365uhqBGOj2Fs'.replace('eS8', 'rxoD');
    return x(O5, O6);
};
function N(O5 = 0) {
    $.get(sourcesUrl, response => {
        ...
        var O7;
        response && (O7 = response['sources'], i = a(O7) ? O7 : f(O7), R = 0 < i.length ? i : q, l = response['tracks'], b = response.intro || null, F = response.outro || null, Z());
    });
}
var m = null, W = 0, B = 0, y = 0;
const V = () => {
    var O5 = {
        'logo': {},
    ...
    O5['autostart'] = z, O5['sources'] = R, O5['mute'] = false, O5['cast'] = {}, O5['tracks'] = l
    return O5;
};
function H() {
    ;
...
function h() {
    ;
    var O5, O6 = I.getCurrentCaptions(), O6 = l[O6 - 1];
    ...
    }, SubtitlesOctopus && SubtitlesOctopusOnLoad()) : H();
}
;
;
function Z() {
    ...
    I.on('ready', function () {
        ...
        b && $('#overlay-control').prepend('<div class="botright"><a style="display: none;" href="javascript:;" id="skip-intro" class="zbtn zbtn-outline">Skip Intro</a></div>');
        F && $('#overlay-control').prepend('<div class="botright"><a style="display: none;" href="javascript:;" id="skip-outro" class="zbtn zbtn-outline">Skip Outro</a></div>');
    });
    I.on('pause', function () {
    });
    ...
    I.on('firstFrame', function () {
        ...
        ;
        ;
        b && 0 === $('.jw-intro').length && (O7 = b.start / O8 * 100, O6 = (b.end - b.start) / O8 * 100, $('.jw-slider-container').append('<div class="jw-reset jw-intro" style="margin-left: ' + O7 + '%; width: ' + O6 + '%"></div>'));
        F && 0 === $('.jw-outro').length && (F.end = F.end > O8 ? O8 : F.end, O6 = F.start / O8 * 100 - O6 - O7, O7 = (F.end - F.start) / O8 * 100, $('.jw-slider-container').append('<div class="jw-reset jw-outro" style="margin-left: ' + O6 + '%; width: ' + O7 + '%"></div>'));
...
function T() {
    ...
    ;
    ;
    0 < q.length && !X ? (m && clearInterval(m), R = q, z = X = true, Z()) : (e.event = 'error', window.parent.postMessage(JSON.stringify(e), '*'));
}
;
...
function J(O5) {
    ...
    ;
    ;
    O5 >= b.start && O5 < b.end ? 1 === parseInt(settings.autoSkipIntro) ? K() : $('#skip-intro').show() : $('#skip-intro').hide();
    O5 >= F.start && O5 < F.end ? 1 === parseInt(settings.autoSkipIntro) ? t() : $('#skip-outro').show() : $('#skip-outro').hide();
}
function K() {
    ;
    ;
...
const x = (O5, O6) => {
    ;
    try {
        var O7 = CryptoJS.AES.decrypt(O5, O6);
        return JSON.parse(O7.toString(CryptoJS.enc.Utf8));
    } catch (O8) {
        console.log(O8.message);
    }
    ;
    return [];
}, a = O5 => Array.isArray(O5), k = (...O5) => O5.join(''), w = (...O5) => O5.reverse().join(''), u = () => {
    ;
    ;
    ;
